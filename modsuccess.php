...
<h1 style="text-align:center;color:red">ITEM MODIFIED SUCCESSFULLY</h1>
<div style="text-align:center"><a href="modifyitem.php"><button type="submit" value="register" name="register" class="btn btn-success">Click here to modify another item</button></a></span></div>
