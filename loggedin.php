...
<?php $_SESSION["total"]=0;$_SESSION["fname"]=$row["fname"];$_SESSION["lname"]=$row["lname"];$_SESSION["mobile"]=$row["mobile"];$_SESSION["email"]=$row["email"];$_SESSION["about"]=$row["about"];$_SESSION["profit"]=0;
