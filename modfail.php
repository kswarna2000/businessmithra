...
<h1 style="text-align:center;color:red">MODIFYING ITEM FAILED </h1>
<h2 style="text-align:center;color:red">PROVIDE EXISTING DETAILS</h2>

<div style="text-align:center"><a href="modifyitem.php"><button type="submit" value="register" name="register" class="btn btn-success">Click here to add another item</button></a></span></div>
<button>
